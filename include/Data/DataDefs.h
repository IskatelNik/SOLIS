...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(EnemyDef, id, name, maxHp, maxWill, hiddenTrait, baseDamage)
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(LoreDef, id, title, text, associatedTrait, argumentText)
